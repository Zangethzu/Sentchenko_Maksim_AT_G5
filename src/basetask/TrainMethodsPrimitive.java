...
public class TrainMethodsPrimitive {
    ...
    public void printByte(byte veryShortNumber) {
        System.out.println("я получил на вход очень короткое число " + veryShortNumber);
    }

    public void printBoolean(boolean boolyValue) {
        System.out.println("я получил на вход булево " + boolyValue);
    }
}
